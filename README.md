...
- [Azure AI Foundry workflow design](docs/foundry-workflows.md)
...
deployment, hosted Credit Policy Assistant agent grounded in Azure AI Search, and
a Foundry smoke evaluation with 2 passed, 0 failed.
