...
```text
Applications with debt-to-income ratio above 45% require an exception review.
```
...
```text
The first retrieval layer uses keyword search. Hybrid retrieval with embeddings
